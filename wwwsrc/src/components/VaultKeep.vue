        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="btn-group dropup">
              <button class="btn delete-btn" @click="deleteVaultKeep(keep.id)" data-dismiss="modal">Remove From
                Vault</button>
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      deleteVaultKeep(keepId) {
        this.$store.dispatch("deleteVaultKeep", { KeepId: keepId, VaultId: parseInt(this.$route.params.VaultId) });
      }
    },
    components: {
      Keep,
